...
public class MyBatisPlusCodeGenerator {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/boot3_security?useSSL=false&useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&serverTimezone=UTC&allowMultiQueries=true";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com.deeeelete";
...
//        completeGenerator();
    ...
    protected static void simpleGenerator() {
        File f = new File(MyBatisPlusCodeGenerator.class.getResource("/").getPath());
        String string = f.toString();
        String[] split = string.split("\\\\target");
        String url = split[0];
        String PROJECT_ROOT_PATH = url.replace("\\","/");
        // 包路径
                ...
                .injectionConfig(builder -> {
                    builder
                            .customFile(new CustomFile
                                    .Builder()
                                    .fileName("Enum"+StringPool.DOT_JAVA)
                                    .templatePath("/templates/entityEnum.java.ftl")
                                    .packageName("com.deeeelete."+MODULE_NAME+".entity.enums")
                            ...
                            .customFile(new CustomFile
                                    ...
                                    .packageName("com.deeeelete."+MODULE_NAME+".entity.dto")
                                    .filePath(packagePath)
                                    .build())
                            .customFile(new CustomFile
                                    .Builder()
                                    .fileName("Query"+StringPool.DOT_JAVA)
                                    .templatePath("/templates/entityQuery.java.ftl")
                                    .packageName("com.deeeelete."+MODULE_NAME+".entity.query")
                                    .filePath(packagePath)
                                    .build())
                            .build();
                })
