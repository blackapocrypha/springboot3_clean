 ...
 * </p>
 */
package com.deeeelete.excel.excel;

import com.deeeelete.excel.common.Constant;
import com.deeeelete.excel.common.StringUtil;
import com.deeeelete.excel.entity.ErrorEntity;
import com.deeeelete.excel.entity.ExcelEntity;
import com.deeeelete.excel.entity.ExcelPropertyEntity;
import com.deeeelete.excel.exception.AllEmptyRowException;
import com.deeeelete.excel.exception.ExcelBootException;
...
import static com.deeeelete.excel.common.DateFormatUtil.parse;
import static com.deeeelete.excel.common.RegexUtil.isMatch;
import static com.deeeelete.excel.common.StringUtil.convertNullTOZERO;
...
public class ExcelReader extends DefaultHandler {
    ...
    private ErrorEntity buildErrorMsg(Integer cellIndex, Object cellValue,
        ...
        errorEntity.setSheetIndex(currentSheetIndex + 1);
        errorEntity.setRowIndex(currentRowIndex + 1);
        errorEntity.setCellIndex(cellIndex + 1);
        errorEntity.setCellValue(StringUtil.convertNull(cellValue));
